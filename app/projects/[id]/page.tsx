...
export default async function Project({ params }: { params: { id: string } }) {
	...
	return (
		<div className="bg-background-primary relative flex flex-col gap-4 p-6">
			<ToggleTheme />
			...
			<div className="flex-center relative">
				...
				<h1 className="mx-3 max-w-[80%] place-self-center text-center text-[28px] font-semibold text-clip">
					{data.name}
				</h1>
			</div>

			<div className="flex-center relative">
				<div className="scrollbar-hidden absolute top-2 left-0 z-5 flex max-w-[100%] gap-2 overflow-x-auto mask-r-from-98% mask-l-from-98% px-2">
					{data.tags.map((tag) => (
