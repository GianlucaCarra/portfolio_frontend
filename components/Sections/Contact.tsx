			...
			<div className="grid gap-3 select-text sm:grid-cols-2 lg:grid-cols-3 lg:gap-4">
				{contacts.map((contact, index) => (
					...
					>
						...
						<h3 className="text-font-primary mb-1 font-semibold">{contact.title}</h3>

						<p className="text-accent mb-2 text-sm">{contact.value}</p>

						<p className="text-font-secondary/80 text-sm">{contact.description}</p>
